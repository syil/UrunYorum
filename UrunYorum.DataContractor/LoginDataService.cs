...
{
    public class LoginDataService : EntityService<ILoginRepository, Login>, ILoginDataService
    {
        public LoginDataService(ILoginRepository repository, IUnitOfWork unitOfWork)
